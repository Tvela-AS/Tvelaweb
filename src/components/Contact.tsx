...
const Contact: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // This would typically send the data to a server or API
      ...
      <div className='container mx-auto px-4 sm:px-6 lg:px-8'>
        <div className='max-w-3xl mx-auto text-center mb-16'>
          ...
          <p className='text-xl text-gray-600'>
            Klar for å diskutere ditt nye prosjekt? Ta kontakt med oss i dag.
          </p>
        </div>

        <div className='grid grid-cols-1 lg:grid-cols-2 gap-8'>
          <div className='bg-navy-900 text-white rounded-xl p-8 shadow-lg'>
            <h3 className='text-2xl font-bold mb-6'>Kontakt Informasjon</h3>

            <div className='space-y-6'>
              <div className='flex items-start'>
                <div className='flex-shrink-0 mr-4 w-10 h-10 bg-emerald-500/20 rounded-full flex items-center justify-center text-emerald-500'>
                  <MapPin size={20} />
                </div>
                <div>
                  <p className='font-medium text-gray-200 mb-1'>Vårt kontor</p>
              ...
              <div className='flex items-start'>
                ...
                <div>
                  <p className='font-medium text-gray-200 mb-1'>Tlf</p>
                  <p className='text-gray-400'>+47 959 61 415</p>
                </div>
              </div>
              ...
              <div className='flex items-start'>
                ...
                <div>
                  ...
                  <p className='text-gray-400'>hei@tvela.no</p>
                </div>
              </div>
            </div>

            <div className='mt-10 pt-8 border-t border-white/10'>
              <h4 className='font-bold mb-4'>Følg oss</h4>
            ...
            <form onSubmit={handleSubmit}>
              <div className='grid grid-cols-1 md:grid-cols-2 gap-6 mb-6'>
                ...
                <div>
                  <label
                    htmlFor='email'
                    className='block text-sm font-medium text-gray-700 mb-1'>
                    Email Addresse <span className='text-red-500'>*</span>
                  </label>
                  <input
                    type='email'
                    id='email'
              ...
              <div className='mb-6'>
                ...
                <textarea
                  ...
                  required
                  rows={5}
                  className='w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-colors'></textarea>
              </div>
