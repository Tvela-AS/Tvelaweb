    ...
    <footer className="bg-navy-950 text-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 py-16">
          <div>
            <h3 className="text-xl font-bold mb-4 text-red-400">Tvela AS</h3>
            <p className="text-gray-300 mb-4">
              Vi er dedikert til å beskytte bedrifter mot cybertrusler gjennom avanserte penetrasjonstester og sikkerhetsløsninger.
            </p>
          ...
          <div>
            <h3 className="text-xl font-bold mb-4 text-red-400">Sikkerhetstjenester</h3>
          ...
          <div>
            <h3 className="text-xl font-bold mb-4 text-red-400">Kontakt</h3>
